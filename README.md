![docker image](https://github.com/exactlab/fairy-magic-oasis/actions/workflows/docker-publish.yml/badge.svg)


<<<<<<< HEAD
# exactlab's NOMAD Oasis Distribution
=======
> [!CAUTION]
...
This is the NOMAD Oasis distribution of exactlab.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/exactlab/fairy-magic-oasis.git
    cd fairy-magic-oasis
    ```

    or

    ```sh
    curl-L -o fairy-magic-oasis.zip "https://github.com/exactlab/fairy-magic-oasis/archive/main.zip"
    unzip fairy-magic-oasis.zip
    cd fairy-magic-oasis
    ```
...
```
docker pull ghcr.io/exactlab/fairy-magic-oasis/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/exactlab/fairy-magic-oasis/manifests/main": unauthorized`
